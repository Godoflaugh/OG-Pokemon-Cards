...
(010, "Caterpie", "https://img.pokemondb.net/artwork/caterpie.jpg", "Bug", "Fire, Flying, Rock", 45, "Its short feet are tipped with suction pads that enable it to tirelessly climb slopes and walls." ),
(011, "Metapod", "https://img.pokemondb.net/artwork/metapod.jpg", "Bug", "Fire, Flying, Rock", 50, "This POKéMON is vulnerable to attack while its shell is soft, exposing its weak and tender body." ),
(012, "Butterfree", "https://img.pokemondb.net/artwork/butterfree.jpg", "Bug, Flying", "Fire, Electricity, Ice, Flying, Rock", 60, "In battle, it flaps its wings at high speed to release highly toxic dust into the air."),
(013, "Weedle", "https://img.pokemondb.net/artwork/weedle.jpg", "Bug, Poison", "Fire, Flying, Psychic, Rock", 40, "Often found in forests, eating leaves. It has a sharp venomous stinger on its head."),
(014, "Kakuna", "https://img.pokemondb.net/artwork/kakuna.jpg", "Bug, Poison", "Fire, Flying, Psychic, Rock", 45, "Almost incapable of moving, this POKéMON can only harden its shell to protect itself from predators."),
(015, "Beedrill", "https://img.pokemondb.net/artwork/beedrill.jpg", "Bug, Poison", "Fire, Flying, Psychic, Rock", 65, "Flies at high speed and attacks using its large venomous stingers on its forelegs and tail."),
(016, "Pidgey", "https://img.pokemondb.net/artwork/pidgey.jpg", "Normal, Flying", "Electricity, Ice, Rock", 40, "A common sight in forests and woods. It flaps its wings at ground level to kick up blinding sand."),
(017, "Pidgeotto", "https://img.pokemondb.net/artwork/pidgeotto.jpg", "Normal, Flying", "Electricity, Ice, Rock", 63, "Very protective of its sprawling territorial area, this POKéMON will fiercely peck at any intruder."),
(018, "Pidgeot", "https://img.pokemondb.net/artwork/pidgeot.jpg", "Normal, Flying", "Electricity, Ice, Rock", 83, "When hunting, it skims the surface of water at high speed to pick off unwary prey such as MAGIKARP."),
(019, "Rattata", "https://img.pokemondb.net/artwork/rattata.jpg", "Normal", "Fighting", 30, "Bites anything when it attacks. Small and very quick, it is a common sight in many places."),
(020, "Raticate", "https://img.pokemondb.net/artwork/raticate.jpg", "Normal", "Fighting", 55, "It uses its whiskers to maintain its balance. It apparently slows down if they are cut off."),
(021, "Spearow", "https://img.pokemondb.net/artwork/spearow.jpg", "Normal, Flying", "Electricity, Ice, Rock", 40, "Eats bugs in grassy areas. It has to flap its short wings at high speed to stay airborne."),
(022, "Fearow", "https://img.pokemondb.net/artwork/fearow.jpg", "Normal, Flying", "Electricity, Ice, Rock", 65, "With its huge and magnificent wings, it can keep aloft without ever having to land for rest."),
